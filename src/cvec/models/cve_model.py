...
# Reference command datamodel-codegen  --input CVE_Record_Format_bundled.json   --input-file-type jsonschema --output-model-type pydantic_v2.BaseModel --output src/cvec/models/cve_model.py
